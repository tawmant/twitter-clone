...
const NavBar = () => {
  return (
    <nav className="navbar__nav py-3 col-2">
      <div className="">
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
        ...
        <li className="nav-item">
          <a href="./index.html">
            <div className="">
              ...
              <span className="nav-item__text">Explore</span>
            </div>
          </a>
        </li>
        <li className="nav-item">
          <a href="./index.html">
            <div>
              ...
              <span className="nav-item__text">Notifications</span>
            </div>
          </a>
        </li>
        <li className="nav-item">
          <a href="./index.html">
            <div>
              ...
              <span className="nav-item__text">Messages</span>
            </div>
          </a>
        </li>
        <li className="nav-item">
        ...
        <li className="nav-item">
          <a href="./index.html">
            <div>
              ...
              <span className="nav-item__text">More</span>
            </div>
          </a>
        </li>
      </ul>
